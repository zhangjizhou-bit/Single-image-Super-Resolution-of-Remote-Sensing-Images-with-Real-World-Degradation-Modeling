...
def main():
    ...
    prog.add_argument('--input-dir', '-i', type=str, default='D:\\Datasets\\AID_all\\sub2', help='path to image input directory.')
    prog.add_argument('--output-dir', '-o', type=str, default='D:\\Datasets\\AID_all\\kernels_train', help='path to image output directory.')
    prog.add_argument('--begin', type=int, default=1)
    prog.add_argument('--end', type=int, default=500)
    prog.add_argument('--X4', action='store_false', default=True, help='The wanted SR scale factor')
    ...
    file_list = os.listdir(os.path.abspath(args.input_dir))
    # for filename in file_list[args.begin-1:args.end-1]:
