...
import models.modules.rban as RBAN_arch
import models.modules.rgn as RGN_arch
import models.modules.rban as RPAN_arch
import models.modules.edsr as EDSR_arch
import models.modules.vdsr as VDSR_arch
import models.modules.ddbpn as DDBPN_arch
import models.modules.srcnn as SRCNN_arch
import models.modules.lapsrn as LAPSRN_arch
import models.modules.drln as DRLN_arch
...
def define_G(opt):
    ...
    if which_model == 'MSRResNet':
        ...
        netG = RCAN_arch.RCAN()
    elif which_model == 'RBAN':
        netG = RBAN_arch.RBAN()
    elif which_model == 'RGN':
        netG = RGN_arch.RGN()
    elif which_model == 'RPAN':
        netG = RPAN_arch.RPAN()
...
def define_D(opt):
    ...
    if which_model == 'NLayerDiscriminator':
        ...
        netD = SRGAN_arch.Discriminator_UNet(input_nc=opt_net['in_nc'], ndf=opt_net['nf'])
    else:
